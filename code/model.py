...
class LINEModel:
    def __init__(self, args):
        ...
        self.embedding = tf.Variable( tf.random_uniform([args.num_of_nodes, args.embedding_dim],minval=-1, maxval=1),name='target_embedding')
        ...
        if args.proximity == 'first-order':
            ...
            self.context_embedding = tf.Variable( tf.random_uniform([args.num_of_nodes, args.embedding_dim],minval=-1, maxval=1),name='context_embedding')
